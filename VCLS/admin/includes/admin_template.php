<?php
// This is the master template for the admin dashboard.

// CORRECTED: Use an absolute server path. $_SERVER['DOCUMENT_ROOT'] points to 'C:/xampp/htdocs'
require_once $_SERVER['DOCUMENT_ROOT'] . '/VCLS/includes/auth_check.php';
require_role('admin');

// Define a constant to allow includes to be accessed
...
<head>
    ...
    <title><?php echo htmlspecialchars($page_title); ?> - Kanenus VC Admin</title>
